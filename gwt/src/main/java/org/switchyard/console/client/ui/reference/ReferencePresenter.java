 ...
 */
public class ReferencePresenter extends Presenter<ReferencePresenter.MyView, ReferencePresenter.MyProxy> {
     ...
     * presenter will load the reference details and pass them back to the view to
     * be displayed.
     * 
